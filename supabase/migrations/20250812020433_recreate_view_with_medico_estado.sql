-- Dropar e recriar a view com o campo medico_estado
...
FROM (
  ...
  LEFT JOIN medicos m ON (
    c.medico_id = m.id 
    AND c.medico_id <> '9cd29712-91b5-492f-86ff-41e38c7b03d5'::uuid
  )
  LEFT JOIN medicos_precadastro mp ON (
    c.medico_precadastro_id = mp.id
  )
