...
-- Recriar a view usando a função que bypassa RLS para contar candidaturas
...
SELECT 
    ...
    combined_data.total_candidaturas,  -- USANDO FUNÇÃO QUE BYPASSA RLS
...
FROM (
    SELECT DISTINCT 
        ...
        g.grupo_nome,
        c.candidaturas_id,
        -- USANDO FUNÇÃO QUE BYPASSA RLS PARA CONTAR TODAS AS CANDIDATURAS
