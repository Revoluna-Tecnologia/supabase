...
-- Recriar a view com lógica simplificada
...
FROM vagas v
    ...
    LEFT JOIN vagas_salvas vs ON (vs.vagas_id = v.vagas_id AND (vs.medico_id = m.id OR (m.id IS NULL AND vs.medico_id IS NOT NULL)));;
