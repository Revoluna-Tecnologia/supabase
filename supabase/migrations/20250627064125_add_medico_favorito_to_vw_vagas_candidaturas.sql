...
-- Recriar a view incluindo medico_favorito
...
FROM (
    SELECT DISTINCT
        ...
        END AS vaga_salva,
        CASE 
            WHEN mf.medico_id IS NOT NULL THEN true 
            ELSE false 
    ...
    FROM vagas v
        ...
        LEFT JOIN medicos_favoritos mf ON (mf.grupo_id = v.grupo_id AND mf.medico_id = vm.medico_id)
) combined_data;;
