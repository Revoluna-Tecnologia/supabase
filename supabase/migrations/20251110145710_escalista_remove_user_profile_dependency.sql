...
-- Atualizar medicos_favoritos: escalista_id deve apontar para o auth_id do escalista
...
-- Atualizar vagas: escalista_id deve apontar para o auth_id do escalista
