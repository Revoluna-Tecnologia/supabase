-- =============================================================================
-- Migration: Support escalistas_externos in vw_vagas_candidaturas
-- Motivo: vagas vindas da Julia podem ter escalista_id NULL e usar
--         vagas.escalista_externo_id. Preserva a versao otimizada da view
--         criada em 20260317200000, adicionando apenas o JOIN externo e os
--         COALESCEs de nome/telefone.
-- =============================================================================
