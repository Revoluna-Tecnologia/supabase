-- Migration: Fix get_applications_paginated function with correct column names
-- Date: 2025-10-14

-- =====================================================
-- Correção da função get_applications_paginated
-- =====================================================
...
CREATE OR REPLACE FUNCTION get_applications_paginated(
    ...
    -- Valores atualizados: 'candidatura_createdate', 'vagas_createdate', 'vagas_data', 'vagas_valor', 'medico_primeiro_nome', 'hospital_nome', 'setor_nome', 'especialidade_nome', 'vagas_periodo_nome', 'vagas_status', 'candidatura_status'
