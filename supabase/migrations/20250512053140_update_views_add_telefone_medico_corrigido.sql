...
-- Atualizar a View de Candidaturas Pendentes para incluir o telefone do médico
...
SELECT 
    ...
    -- Telefone do médico (nova coluna)
...
-- Atualizar a View de Todas as Candidaturas para incluir o telefone do médico
