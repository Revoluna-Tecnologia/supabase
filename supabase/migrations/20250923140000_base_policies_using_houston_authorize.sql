...
-- =============================
-- Futuro: policies para Membros (membros.view/add/edit/remove) quando a tabela alvo for definida.
-- =============================


-- =============================
-- Exemplo de atribuição de papel a um usuário específico (substituir UUIDs conforme
