...
-- Recriar a view com lógica de UNION para mostrar todas as combinações vaga-médico
...
SELECT 
    ...
    vaga_salva
FROM (
    -- Todas as combinações únicas de vaga-médico (de candidaturas E vagas_salvas)
    SELECT DISTINCT
        v.vagas_id,
        v.vagas_data,
        v.vagas_createdate,
    ...
    FROM vagas v
        ...
        LEFT JOIN (
            -- União de médicos de candidaturas e vagas_salvas
